      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">{statistics.totalPoints.toLocaleString()}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">{statistics.pointsThisMonth.toLocaleString()}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Earned in May
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>{statistics.pointsToNextLevel.toLocaleString()} points needed</span>
